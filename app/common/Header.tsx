...
import { categories } from '../(page)/_components/CategoryList'
  ...
  return (
    <>
      {isSticky ? (
        <>
          <header
            className={`h-26 sticky top-0 z-50 mx-auto flex w-screen flex-col items-center justify-between border-b border-gray-300 bg-white py-8`}
          >
